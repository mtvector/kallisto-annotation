...
python3 ${SCRIPTPATH}/GTF2BED.py ${GTF}.gtf transcript
...
python3 $SCRIPTPATH/GTF2BED.py exon_sorted.gtf transcript
...
python3 $SCRIPTPATH/GTF2BED.py transcript_sorted.gtf transcript
...
python3 $SCRIPTPATH/CorrectFaHeader.py ${GTF}.gtf cDNA.fa cDNA.correct_header.fa transcript
python3 $SCRIPTPATH/CorrectFaHeader.py ${GTF}.gtf introns.fa introns.correct_header.fa transcript -I                      
